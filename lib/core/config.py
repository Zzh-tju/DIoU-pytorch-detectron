...
# DIoU-NMS
# ---------------------------------------------------------------------------- #
__C.TEST.DIOU_NMS = AttrDict()

# Use DIoU-NMS instead of greedy-NMS if set to True
__C.TEST.DIOU_NMS.ENABLED = True
# See DIoU paper for definition of these options, we found that R_DIoU can add power to get better performance.
# For dense anchor algorithms, beta1 is usually set to 0.9, 1.0 or 1.1. That is close to the original definition of DIoU. It is usually better than greedy-NMS.
__C.TEST.DIOU_NMS.BETA1 = 1.0
# For the DIoU-NMS overlap threshold, we simply use TEST.NMS
